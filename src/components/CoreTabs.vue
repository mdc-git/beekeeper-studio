<template>
  <div class="core-tabs" v-hotkey="keymap">
    <div class="tabs-header">
      ...
      <span class="actions">
        <a @click.prevent="createQuery(null)" class="btn-fab add-query"
    ...
    <div class="tab-content">
      ...
      >
        ...
        ></QueryEditor>
        <TableTable
          @setTabTitleScope="setTabTitleScope"
          v-if="tab.type === 'table'"
          :active="activeTab === tab"
          :tabId="tab.id"
...
export default {
  ...
  methods: {
    ...
    openTable({ table, filter, tableName }) {
      ...
      if (!table && tableName) {
        resolvedTable = this.$store.state.tables.find(
          (t) => t.name === tableName
        );
      }
      const t = {
